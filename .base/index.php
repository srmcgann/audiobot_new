...
<html>
  <head>
    ...
    <style>
      ...
      #downloadPlaylistModal{
        z-index: 100;
        font-size: 20px;
        background-image: url(https://jsbot.whitehot.ninja/uploads/1lBraI.gif);
  ...
  <body>
    ...
    <div id="downloadPlaylistModal" class="modal">
      <button onclick="closeModal('#downloadPlaylistModal')" class="closeButton normalButtons">close</button><br><br>
      your tracks are being zipped...<br>
      the file will be downloaded automatically when it is ready...<br><br>
      but this could take a looooooong time, depending on the size of the playlist<br><br>
    ...
    <div class="main">
      ...
      <button onclick="showModal('#downloadPlaylistModal')" class="normalButtons">download playlist as zip</button>
      <br><br>
      <div id="iframeDiv">
        <iframe
          class="playerFrame"
    ...
    <script>
      ...
      search=()=>{
        ...
        fetch('search.php',{
          ...
          if(data[0]){
            ...
            searchResults.innerHTML+=`]<br></div><div id="youtubeDiv">`
      ...
      showModal=modal=>{
        ...
        if(modal == '#downloadPlaylistModal'){
          sendData = { }
          fetch('zip.php',{
            method: 'POST',
            headers: {
            ...
            if(data[0]){
              ...
              el.href = 'tracks.zip?'+(Math.random()*1e5|0)
              el.download = decodeURIComponent(window.location.pathname.split('/')[1]) + '_tracks.zip'
              el.target = '_blank'
